...
import com.example.chonlaphoom.fullcourse.DialogConnect;
import com.example.chonlaphoom.fullcourse.NewFeeds;
import com.example.chonlaphoom.fullcourse.R;
 ...
 */
public class ConnectGetSumPrice extends AsyncTask<String, Integer, String>  {
    ...
    ConnectGetSumPrice(Context context, String URL){
            ...
            try {
                ...
                if(jObject.getString("status").equals("OK")){
                    ...
                    for(int i=0;i<size;i++){
                        ...
                        int dataprice = jResult.getJSONObject(i).getInt("sum(b.price)");
                        //    String data2  = jResult.getJSONObject(i).getString("name");
                        sumprice.add(dataprice);
                ...
                ((NewFeeds)context).getFullPrice(fullcourse_id,sumprice);
