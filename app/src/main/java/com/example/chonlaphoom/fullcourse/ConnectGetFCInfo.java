...
public class ConnectGetFCInfo extends AsyncTask<String, Integer, String> {
    ...
    ConnectGetFCInfo(Context context, String URL){
    ...
    protected void onPostExecute(String result) {
        ...
        ArrayList<Integer> food_price = new ArrayList<Integer>();
        ...
        if(result != null){
            ...
            try {
                ...
                if(jObject.getString("status").equals("OK")){
                    ...
                    for(int i=0;i<size;i++){
                        ...
                        String sfood_name = jResult.getJSONObject(i).getString("name");
                        int sfood_price = jResult.getJSONObject(i).getInt("price");
                        String srest_name = jResult.getJSONObject(i).getString("res_name");
                    //    String data2  = jResult.getJSONObject(i).getString("name");

                        food_name.add(sfood_name);
                        rest_name.add(srest_name);
                        food_price.add(sfood_price);
                     //   name.add(data2);
                    ...
                    ((FCinfo)context).errorConnectToServer();
                }
                ((FCinfo)context).setList(food_name,rest_name,food_price);
            ...
            ((FCinfo)context).cannotConnectToServer();
        }
