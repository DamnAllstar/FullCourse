 ...
 */
public class ConnectGetFullOwner extends AsyncTask<String, Integer, String>  {
    ...
    ConnectGetFullOwner(Context context, String URL){
    ...
    protected void onPostExecute(String result) {
        ...
        if(result != null){
            ...
            try {
                ...
                ((FCinfo)context).getFullOwner(name);
