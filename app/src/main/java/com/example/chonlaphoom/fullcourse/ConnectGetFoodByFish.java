 ...
 */
public class ConnectGetFoodByFish extends AsyncTask<String, Integer, String> {
    ...
    ConnectGetFoodByFish(Context context, String URL){
    ...
    protected void onPostExecute(String result) {
        ...
        if(result != null){
            ...
            try {
                ...
                ((FCRegister)context).getFish(name);
