 ...
 */
public class ConnectGetFoodByMain extends AsyncTask<String, Integer, String> {
    ...
    ConnectGetFoodByMain(Context context, String URL){
    ...
    protected void onPostExecute(String result) {
        ...
        if(result != null){
            ...
            try {
                ...
                ((FCRegister)context).getMain(name);
