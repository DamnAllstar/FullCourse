 ...
 */
public class ConnectGetFoodByDessert extends AsyncTask<String, Integer, String> {
    ...
    ConnectGetFoodByDessert(Context context, String URL){
    ...
    protected void onPostExecute(String result) {
        ...
        if(result != null){
            ...
            try {
                ...
                ((FCRegister)context).getDessert(name);
