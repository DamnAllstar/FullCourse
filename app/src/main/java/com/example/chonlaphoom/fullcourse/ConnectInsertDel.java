...
public class ConnectInsertDel extends AsyncTask<String, Integer, String> {
    ...
    protected void onPostExecute(String result) {
        ...
        if(result != null){
            ...
            try {
                ...
                //    ((MainActivity)context).NewPage();

                    //ถ้าดึงข้อมูลจาก database มีปัญหาจะแสดง error
                }else{
                    ((MainActivity)context).errorConnectToServer();
                }
                //((renew_password_page)context).setList(list);

                //System.out.println("n = "+listnum.get(0));
