 ...
 */
public class ConnectGetFoodByMeat extends AsyncTask<String, Integer, String> {
    ...
    ConnectGetFoodByMeat(Context context, String URL){
    ...
    protected void onPostExecute(String result) {
        ...
        if(result != null){
            ...
            try {
                ...
                ((FCRegister)context).getMeat(name);
